...
<script>
    ...
    return {
      script: [
        { src: "https://js.api.here.com/v3/3.0/mapsjs-core.js",type: "text/javascript"},
        { src: "https://js.api.here.com/v3/3.0/mapsjs-service.js",type: "text/javascript"}
      ],
      link: [
        { rel: 'stylesheet', href: 'https://developer.here.com/api-explorer' }
      ]
    };
  },
        data() {
