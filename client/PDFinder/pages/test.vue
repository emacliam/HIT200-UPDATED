<template>
  <div>
    <p>Please Drag the red pointer to your location and hit send</p>
   <div id="map" class="border border-teal w-"></div>
  <div>
...
<span @click="send()"  title="Send your location" class="cursor-pointer border-2 rounded p-2 bg-teal-600 text-white">Send location</span>
  </div>
