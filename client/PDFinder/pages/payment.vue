...
<section>
	...
	<p class="text-center text-lg text-gray-700 mt-2 px-6">
		Select the best pricing that suits you
	</p>
	<div
	...
	<h2 class="text-sm text-teal-500 text-center pb-1">SMALL BUSINESS ENTERPRISE eg.Personal Flee Markets,Bhero's</h2>

    <p class="bg-teal-600 rounded-lg px-2 w-auto text-white"> Free For 1 month</p>
...
<span class="text-gray-700 text-lg ml-3"
>Limited Product Uploads(30 /mo)</span
>
</li>
<li class="flex items-center">
	<div
...
<span class="text-gray-700 text-lg ml-3">High search priority For exposure</span>
</li>
</ul>
</div>
...
>
<div
class="text-sm leading-none rounded-t-lg bg-teal-300 text-black font-semibold uppercase py-4 text-center tracking-wide"
>
Most Popular
</div>
<div
...
<h2 class="text-sm text-teal-500 text-center pb-6"><span class="text-3xl">$190</span> /mo</h2>

This package is for Experts/shop owners with many product lines.
</div>
<div class="flex pl-12 justify-start sm:justify-start mt-3">
	...
	<span class="text-gray-700 text-lg ml-3">Platform Advertisement</span>
</li>
<li class="flex items-center">
	<div
	class=" rounded-full p-2 fill-current text-green-700"
...
<span class="text-gray-700 text-lg ml-3">Products limited to 500 /mo</span>
</li>
</ul>
</div>
...
<h2 class="text-sm text-teal-500 text-center pb-6">$390 /mo</h2>
</div>
<div class="flex flex-wrap mt-3 px-6">
	<ul>
		<li class="flex items-center">
	...
	<span class="text-gray-700 text-lg ml-3"
	>Platform and External Advertisement </span
	>
</li>
<li class="flex items-center">
	<div
    ...
    methods: {
       async Basic(){
            ...
            if(response.success){
                ...
                this.$toast.error('Sorry there seem to be a problem. Please report it on the landing page "Requests & Reports" ').goAway(2000)
            }
