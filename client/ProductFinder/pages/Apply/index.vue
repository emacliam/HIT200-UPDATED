...
<div class="bg-gray-200 flex w-full">
        <div class="w-1/4 h-screen bg-gray-800 mt-8 sm:mt-0">
            <div class="flex items-center justify-center mt-10">
                <img class="h-6" src="https://premium-tailwindcomponents.netlify.app/assets/svg/tailwindcomponent-light.svg">
            </div>

            <nav class="mt-10">
                <a class="flex items-center py-2 px-8 block bg-gray-700 text-gray-100 border-r-4 border-gray-100" href="#">
                ...
                <a class="flex items-center mt-5 py-2 px-8 block text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100" href="#">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="absolute bottom-0 my-10">
                <a class="flex items-center py-2 px-8 block text-gray-600 hover:text-gray-500" href="#">
...
<div id="menu" class="container p-8 w-3/4 lg:pt-24 lg:pb-64 overflow-y-scroll h-screen flex-grow">
      ...
      <nuxt-link :to="`/apply/${apply._id}`" class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-6 xl:grid-cols-6 gap-4" v-for="apply in apply" :key="apply._id">
        ...
        <div>
 <div class="col-span-2 sm:col-span-1 xl:col-span-1 italic ">Date:{{apply.date.slice(0,10)}}</div>
        <div class="col-span-2 sm:col-span-1 xl:col-span-1 italic ">Time:{{apply.date.slice(11,20)}}</div>
        </div>
...
export default {
  async asyncData({$axios}){
    try {
      let response = await $axios.$get('/api/apply');
      return{
